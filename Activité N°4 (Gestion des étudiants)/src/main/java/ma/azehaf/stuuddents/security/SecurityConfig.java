...
import static ma.azehaf.stuuddents.StuuddentsApplication.logoutSuccessHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.logout().logoutSuccessHandler(logoutSuccessHandler());//.clearAuthentication(true);
